            ...
            <View style={{ position: "absolute", alignItems: "center" }}>
                <Animated.View style={{ position: "absolute", left: thermometerX, top: thermometerY }}>
                    <View style={styles.secondaryButton}>
                        ...
                        <Icon name="md-reorder" size={32} color='#fff' />
                    </View>
                </Animated.View>
                <Animated.View style={{ position: "absolute", left: timeX, top: timeY }}>
                    <View style={styles.secondaryButton}>
                        
                        <Icon name="ios-heart" size={32} color='#fff' />
                    </View>
                </Animated.View>
                <Animated.View style={{ position: "absolute", left: pulseX, top: pulseY }}>
                    <View style={styles.secondaryButton}>
                       
                        <Icon name="ios-apps" size={32} color='#fff' />
                    </View>
                </Animated.View>
                <Animated.View style={[styles.button, sizeStyle]}>
                    <TouchableHighlight onPress={this.handlePress} underlayColor="#7F58FF">
                        <Animated.View style={{ transform: [{ rotate: rotation }] }}>
                            ...
                            <Icon name="ios-add-circle" size={32} color='#fff' />
                        </Animated.View>
                    </TouchableHighlight>
                </Animated.View>
            </View>
